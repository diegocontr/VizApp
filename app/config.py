...
config_labels = {
    ...
    "headers": {"main": "📊 Mock Database Visualization", "dataframes": "View Underlying Data"},
    "download_buttons": {"df_csv": "Download Line Plot Data as CSV", "dfh_csv": "Download Bar Plot Data as CSV"},
    "help": {
    ...
    "labels": {"bar_plot": "Bar Plot", "bar_plot_var_y": "Bar Plot Var Y"},
}
