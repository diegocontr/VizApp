...
def create_figure(
    ...
    fig_plotly = make_subplots(
        rows=3 if add_third_subplot else 2,
        cols=1,
    ...
    dfh_first = prepare_bar_plot_data(
        data_dict,
        selected_db,
        selected_analysis,
        selected_column,
...
def apply_custom_xticks(fig_plotly, custom_xticks, selected_column, add_third_subplot):
    ...
    if selected_column in custom_xticks:
        ...
        fig_plotly.update_xaxes(tickmode="array", tickvals=xticks, ticktext=xticklabels, row=1, col=1)
        fig_plotly.update_xaxes(tickmode="array", tickvals=xticks, ticktext=xticklabels, row=2, col=1)
        if add_third_subplot:
            fig_plotly.update_xaxes(tickmode="array", tickvals=xticks, ticktext=xticklabels, row=3, col=1)
